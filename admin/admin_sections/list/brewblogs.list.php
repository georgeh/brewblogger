...
<table class="dataTable">
    ...
    <tr <?php echo " style=\"background-color:$color\"";?>>
		...
		<?php if (!checkmobile()) { ?>
        <td class="data-icon_list"><a href="#" onclick="window.open('/export/beerxml?id=<?php echo $row_brewing['id']; ?>&source=brewLog&brewStyle=<?php echo $row_brewing['brewStyle']; ?>','','height=1,width=1, scrollbars=no, toolbar=no, resizable==no, menubar=no'); return false;"><img src="<?php echo $imageSrc; ?>page_white_code.png" title="Download BeerXML" align="absmiddle" border="0" /></a>    
